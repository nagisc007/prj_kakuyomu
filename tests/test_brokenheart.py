# -*- coding: utf-8 -*-
"""Test: The collect broken heart
"""
import unittest
from storybuilder.builder import testutils as utl
from src.brokenheart.story import world, story, story_baseinfo, story_outline
from src.brokenheart.config import THEMES, MOTIFS


_FILENAME = "brokenheart.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The broken heart project")
